...
SECTIONS = [
 ...
 {"id": "note", "heading": "Burroughs and the Word Virus", "register": "D", "body": [
  "This is a chronological account. It begins with the earliest surviving mention of "
  "Burroughs in the archive and works forward through everything: 38 passages of "
  "Exegesis, 12 letters, one interview, one essay, and what the secondary literature "
  "makes of it. The open questions are raised where they arise rather than collected "
  "at the end, because most of them are questions about a particular moment.",

  "The order took some establishing. Our records date each Exegesis container document "
  "once, and for the section we had been calling “October 10, 1978” that date is wrong "
  "for most of its contents: six of its passages carry internal date stamps from "
  "September to December 1980 — “9-10-80”, “10-20-80”, “11-17-80” — and the published "
  "edition independently places three of them in late 1980. What had looked like a "
  "middle phase in 1978 turns out to be mostly a burst in the autumn of 1980, eighteen "
  "months later and much closer to the VALIS letters. Dates below are given per passage "
  "with the evidence behind them; where nothing settles a date, the page says so.",

  "A related question the archive cannot answer: why the 2011 Jackson and Lethem "
  "edition prints only eight of our thirty-four Exegesis passages, leaving out the "
  "anti-information redefinition, the 1978 revaluation of the virus as a cure, and the "
  "whole persistence of the occluding reading in 1981 — arguably the most interesting "
  "material. Editorial selection, or folders the editors did not have? Comparing our "
  "folder stamps against their stated selection principles would settle it.",
 ]},
