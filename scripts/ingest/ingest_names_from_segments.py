...
ENTITY_TYPE_OVERRIDES = {
    ...
    'jason taverner': 'character',
    'felix buckman': 'character',
    'barney mayerson': 'character',
    'leo bulero': 'character',
    'seth morley': 'character',
    'eric sweetscent': 'character',
    'rachael rosen': 'character',
    'isidore': 'character',
    'pris stratton': 'character',
    'roy baty': 'character',
    'donna hawthorne': 'character',
    'james barris': 'character',
    'frank frink': 'character',
    'juliana frink': 'character',
    'robert childan': 'character',
    'hawthorne abendsen': 'character',
    'manfred steiner': 'character',
    'arnie kott': 'character',
    'chuck rittersdorf': 'character',
    'nicole thibodeaux': 'character',
    'ferris f. fremont': 'character',
    'ted schoenheit': 'character',
    'joe fernwright': 'character',
    'hoppy harrington': 'character',
    'bruno bluthgeld': 'character',
    'stuart mcconchie': 'character',
    'walt dangerfield': 'character',
    'luba luft': 'character',
    'buster friendly': 'character',
    'phil resch': 'character',
    'pete sands': 'character',
    'dr. abernathy': 'character',
